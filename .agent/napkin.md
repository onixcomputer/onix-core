...
| 2026-03-22 | self | cloud-hypervisor guest VM sends zero packets on TAP interface despite booting to multi-user | Needs serial console debugging — networkd may not have brought up the virtio-net interface, or the .network file matching failed |
