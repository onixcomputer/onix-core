...
- [ ] [serial] r[onix.campaign_source.deployment] Integrate the user-approved live SearXNG/Kagi and Collie sources from an isolated snapshot and preserve other primary work.
