...
- [x] [serial] Deploy the private canary to `britton-desktop` and run accepted, rejected, unavailable, and uncertain drills. r[onix.kiln_aspen_canary.evidence]
- [x] [serial] Retain the exact bounded receipt and verify every deployment non-claim. r[onix.kiln_aspen_canary.evidence]
- [x] [serial] Sync and archive only after all dependency and live evidence gates pass. r[onix.kiln_aspen_canary.evidence]
