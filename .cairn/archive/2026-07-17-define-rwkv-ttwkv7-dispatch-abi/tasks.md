...
- [x] [serial] Frame the bounded dispatch-ABI goal, false-completion cases, architecture alternatives, and non-claims r[onix.tenstorrent.native_runtime.rwkv_lab.ttwkv7_dispatch_abi]
- [x] [serial] Define canonical request/response types and pure exact-byte framing cores r[onix.tenstorrent.native_runtime.rwkv_lab.ttwkv7_dispatch_abi]
- [x] [serial] Add the shared CPU BF16 emulator and strict response/transcript validator r[onix.tenstorrent.native_runtime.rwkv_lab.ttwkv7_dispatch_abi]
