...
let
  ...
  services = {
    ...
    clan-var-echo = import ./clan-var-echo.nix { inherit inputs; };
    demo-credentials = import ./demo-credentials.nix { inherit inputs; };
    ...
    # See inventory/services/microvm.nix for example configurations (commented out)
