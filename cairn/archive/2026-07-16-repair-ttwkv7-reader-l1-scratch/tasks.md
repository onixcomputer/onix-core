...
- [x] [serial] Sync the accepted requirement, archive the change with exact evidence, and make no physical-correctness claim. r[onix.tenstorrent.native_runtime.ttwkv7.reader_gather_alignment]
