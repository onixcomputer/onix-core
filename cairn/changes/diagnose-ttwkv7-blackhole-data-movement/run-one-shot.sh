...
readonly reviewed_base_commit="dc2984a4bb94f73d961ca5b7ca6ec509ae938992"
...
readonly package_path="/nix/store/1x99jci2lnw034h9xyg6ijm6cb7h6d7m-ttwkv7-unstable-2026-06-22"
...
readonly kernel_path="/nix/store/nzcin5jx404z35hq71nz5154ca9qx9y6-ttwkv7-kernels-unstable-2026-06-22/share/ttwkv7/kernels"
...
readonly expected_authorization="Authorize exactly one device-1 data-movement diagnostic process."
readonly run_root="/var/tmp/ttwkv7-data-movement-20260716T205921Z"
...
readonly rollback_unit="ttwkv7-owner-rollback-20260716T205921Z"
...
fail() {
  printf 'ttWKV7 data-movement one-shot: %s\n' "$1" >&2
