...
- [x] [serial] Add a reusable Nickel contract for builder targets. r[onix.remote_builder.routing.contract]
- [x] [serial] Add Aspen's explicit `aspen1.local` builder endpoint. r[onix.remote_builder.routing.aspen]
- [x] [serial] Select explicit endpoints before inventory LAN addresses. r[onix.remote_builder.routing.selection]
