...
- [x] [depends:V1] I2 Build and deploy both reviewed host closures, reconcile exactly three native policies, and verify the private identity/object refs on each seed. r[onix.radicle_private_pilot.replication]
...
- [ ] [depends:V2] [depends:V3] V4 Complete encrypted backup and clean-root recovery with a semantic private-object probe. r[onix.radicle_private_pilot.recovery]
- [ ] [depends:V4] D1 Export typed JSON/BLAKE3 evidence and document operations, rollback, authority boundaries, and non-claims. r[onix.radicle_private_pilot.evidence]
