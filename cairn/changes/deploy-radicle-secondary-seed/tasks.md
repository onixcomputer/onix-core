...
- [x] [serial] Generate and pin the distinct replica node identity, create the bounded dataset, deploy to `britton-desktop` through its pinned tailnet host key, and reconcile exactly the pilot RID. r[onix.radicle_replica.deployment]
- [x] [parallel] Verify service hardening, listener/firewall scope, restart continuity, exact repository/object storage, monitoring, and absence of delegate/CI/deployment/release/cache authority. r[onix.radicle_replica.authority]
