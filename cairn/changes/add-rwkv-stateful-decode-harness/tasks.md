...
- [ ] [serial] Run focused validation, lock the real-checkpoint decode receipt, sync the requirement, archive the change, and retain tokenizer, hardware, and text claims as excluded. r[onix.tenstorrent.native_runtime.rwkv_lab.stateful_decode]
