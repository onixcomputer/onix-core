...
- [ ] [serial] Assign Aspen1 the least-authority Radicle service with dedicated user, persistent state, explicit public repository allowlist, and no access to delegate, CI, deployment, release, canonical-ref, cache, artifact, Buildbot, Nix-signing, Cloudflare, Vaultwarden, Matrix, or other co-hosted credentials. r[onix.radicle_node.hosting]
