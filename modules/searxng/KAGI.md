...
This policy is not yet activated on Aspen3. Its deployment preview includes unrelated package changes, so activation remains blocked.
After a safe deployment, restart LibreWolf so the new policy loads.
