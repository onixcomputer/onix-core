...
lib.concatLists [
  ...
  (rejectUnless seedRepositoriesAreGoverned "seedRepositories must contain exactly the governed Bounded Exec, artifact-auth, execution-graph, and durable-file-publication RIDs in the public set")
  ...
  (rejectUnless httpsGitRepositoriesAreGoverned "enabled HTTPS Git must expose exactly the governed Bounded Exec, artifact-auth, execution-graph, and durable-file-publication RIDs")
