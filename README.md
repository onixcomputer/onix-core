...
## References
- [BlinkDL/RWKV-LM](https://github.com/BlinkDL/RWKV-LM) — official RWKV-7 model and NumPy equation reference used by the real-weight layer harness.
- [fla-org/flash-linear-attention](https://github.com/fla-org/flash-linear-attention) — v0.3.0 checkpoint naming and RWKV-7 block wiring used to decode the Hugging Face model format.
...
- [RWKV/RWKV7-Goose-World2.8-0.1B-HF](https://huggingface.co/RWKV/RWKV7-Goose-World2.8-0.1B-HF) — pinned Apache-2.0 BF16 checkpoint used by the device-free real-weight layer harness.
