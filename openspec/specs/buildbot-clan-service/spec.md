# buildbot-clan-service Specification

## Purpose
Define the Buildbot clan service module, including master/worker roles, inventory ownership, clan-vars secret handling, buildbot-nix import containment, and parity with the prior aspen1 direct configuration.
