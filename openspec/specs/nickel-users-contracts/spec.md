# Nickel Users Contracts Specification

## Purpose

This specification records requirements synced from OpenSpec change `nickel-users-migration`.

## Requirements

<!-- synced from openspec change: nickel-users-migration -->
## ADDED Requirements
