...
### Requirement: Clan service module with master and worker roles
...
#### Scenario: Module registered in modules/default.nix
...
#### Scenario: Master role produces valid NixOS config
...
#### Scenario: Worker role produces valid NixOS config
...
### Requirement: Master role manages all secrets via clan vars generators
...
#### Scenario: Worker password and workers JSON generation
...
#### Scenario: GitHub secrets generation
- **WHEN** the master role perInstance is applied
...
#### Scenario: Generator names match existing vars
...
### Requirement: Settings interface with freeform passthrough
...
#### Scenario: Master high-level settings
...
#### Scenario: Freeform passthrough for master
...
#### Scenario: Inventory instance defines master on aspen1
...
#### Scenario: ntfy notification on build failure
...
#### Scenario: Output store paths written for update-prefetch
