      ...
      modules = [
        ...
        (
          { lib, ... }:
          {
            ...
            config = {
              clan.core.vars.generators."searxng-${fixtureName}".files."env-file".path = secretPath;
              clan.core.vars.generators."searxng-${fixtureName}-kagi".files."env-file".path = kagiSecretPath;
